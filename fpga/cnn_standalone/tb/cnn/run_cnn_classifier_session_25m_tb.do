...
set out_dir "$prj_root/sim/out/cnn_classifier_session_25m"
set lib_name work_cnn_classifier_session_25m
set lib_dir "$out_dir/$lib_name"
set log_file "$out_dir/cnn_classifier_session_25m.log"
...
foreach required [list \
    ...
    "$prj_root/tb/cnn/cnn_classifier_session_25m_tb.sv"] {
...
vlog -work $lib_name "$prj_root/rtl/cnn/cnn_weight_rom.v"
vlog -work $lib_name "$prj_root/rtl/cnn/cnn_flat_classifier.v"
vlog -work $lib_name "$prj_root/rtl/cnn/cnn_classifier_session_25m.v"
vlog -work $lib_name -sv "$prj_root/tb/cnn/cnn_classifier_session_25m_tb.sv"
vsim -c -l $log_file -suppress 2685 -suppress 2718 $lib_name.cnn_classifier_session_25m_tb
run -all
quit -f
