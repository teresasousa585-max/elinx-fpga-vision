# eLinex FPGA 实时视觉处理系统

面向 2026 年全国大学生集成电路创新创业大赛的 FPGA 实时图像处理项目。系统以 OV5640 摄像头采集视频，在 FPGA 端完成颜色空间转换、缩放、旋转、滤波、增强等处理，并通过 HDMI 与 UDP 图传输出；PyQt6 上位机负责串口算法切换、实时预览、截图和录像。
...
- 代码注释统一采用中文职责说明，信号、模块与协议名称保留英文标识。
